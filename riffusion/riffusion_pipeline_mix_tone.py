...
class RiffusionPipeline(DiffusionPipeline):
    ...
    def load_checkpoint(
        ...
        # Load components individually to avoid parameter validation issues
        ...
        unet = UNet2DConditionModel.from_pretrained(checkpoint, subfolder="unet", torch_dtype=dtype)
    ...
    # NOTE The function is designed to interpolate between two different prompts/conditions:
    @torch.no_grad()
        ...
        **kwargs,
        ...
        for i, t in enumerate(self.progress_bar(timesteps)):
            ...
            if masks is not None:
                ...
                # TODO adapt the following mix style transfer from the paper
                # https://arxiv.org/abs/2411.15913 A Training-Free Approach for Music Style Transfer with Latent Diffusion Models (Heehwan, Wang, et al.)
