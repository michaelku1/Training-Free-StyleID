...
class style_transfer_module():
    ...
    def __init__(self,
        ...
        style_transfer_params_default = {
            ...
            # Specific layers 7-11: These correspond to:
            # Layer 7: Up block 2, layer 1 (attention layer)
            # Layer 8: Up block 2, layer 2 (attention layer)
            # Layer 9: Up block 3, layer 0 (attention layer)
            # Layer 10: Up block 3, layer 1 (attention layer)
            # Layer 11: Up block 3, layer 2 (attention layer)
